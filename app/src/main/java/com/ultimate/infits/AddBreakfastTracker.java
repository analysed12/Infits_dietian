...
public class AddBreakfastTracker extends RecyclerView.Adapter<AddBreakfastTracker.AddBreakfastViewHolder> {

    List<ModelForFood> breakfastList;
    Context context;
    AddButtonListenerChart addButtonListenerChart;

    public AddBreakfastTracker(List<ModelForFood> breakfastList, Context context, AddButtonListenerChart addButtonListenerChart) {
